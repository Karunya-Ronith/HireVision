...
from config import ERROR_MESSAGES, MAX_FILE_SIZE, SUPPORTED_FILE_TYPES, MAX_RETRIES, RETRY_DELAY
...
def validate_inputs(pdf_file, job_description: str) -> Tuple[bool, str]:
    ...
    try:
        ...
        if len(job_description.strip()) < 10:
            return False, "Please provide a more detailed job description (at least 10 characters)."

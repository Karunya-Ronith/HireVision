...
from utils import (
    validate_inputs, sanitize_input, clean_text, truncate_text,
    extract_json_from_text, create_fallback_analysis, create_error_analysis
)
...
def test_utils():
    ...
    assert extracted is not None and extracted["test"] == "value", "JSON extraction failed"
